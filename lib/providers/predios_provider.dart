...
class PredioProvider extends ChangeNotifier {
  ...
  getDatos(String contrib) async {
    final url = Uri.parse(
        'https://g63vp7mq-7234.brs.devtunnels.ms/clienteJesus/DatosContribuyente?Contribuyente=$contrib');
  ...
  prediosDetalles(String contrib, String anio) async {
    String tributo = '001';
    final url = Uri.parse(
        'https://g63vp7mq-7234.brs.devtunnels.ms/clienteJesus/DetallesPredioPorAño?Contribuyente=$contrib&Ano=$anio&Tributo=$tributo');
    final urls = Uri.parse(
        'https://g63vp7mq-7234.brs.devtunnels.ms/clienteJesus/TotalPredioPorAño?Contribuyente=$contrib&Ano=$anio&Tributo=$tributo');
  ...
  getPredios(String contrib) async {
    ...
    final url = Uri.parse(
        'https://g63vp7mq-7234.brs.devtunnels.ms/clienteJesus/PrediosAgrupadosPorAño?Contribuyente=$contrib&Tributo=$tributo'); //Predios
    final urls = Uri.parse(
        'https://g63vp7mq-7234.brs.devtunnels.ms/clienteJesus/TotalesPrediosFraccionadosYDeuda?Contribuyente=$contrib&Tributo=$tributo'); // totales
    final urlTree = Uri.parse(
        'https://g63vp7mq-7234.brs.devtunnels.ms/clienteJesus/SumaTotales?Contribuyente=$contrib&Tributo=$tributo');
    print('**************************************');
    print(url);
    print(urls);
    print(urlTree);
