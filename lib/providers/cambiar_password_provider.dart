...
class CambiarPasswordProvider extends ChangeNotifier{
  ...
  enviarCodigo(String dni)async{
    final url = Uri.parse('https://g63vp7mq-7234.brs.devtunnels.ms/cliente/RestablecerContrasena?Documento=$dni');
  ...
  CambiarPassword(String dni, String password,String codigo)async{
    final url = Uri.parse('https://g63vp7mq-7234.brs.devtunnels.ms/cliente/CambioContrasena');
