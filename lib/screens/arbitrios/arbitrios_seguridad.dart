...
class _ArbitriosSeguridadState extends State<ArbitriosSeguridad> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> lista_deudas_por_anios =
        arbitriosProvider.listaDeudasPorAniosSeguridad;

    final List<dynamic> lista_total = arbitriosProvider.totalSeguridad;
    ...
    final String global = arbitriosProvider.arbitriosGlobalSeguridad;
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () async {
                              ...
                              final deudasProvider =
                                  Provider.of<SeguridadProvider>(context,
                                      listen: false);
