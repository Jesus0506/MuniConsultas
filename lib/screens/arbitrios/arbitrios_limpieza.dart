...
class _ArbitriosLimpiezaState extends State<ArbitriosLimpieza> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> lista_deudas_por_anios =
        arbitriosProvider.listaDeudasPorAniosLimpieza;

    final List<dynamic> lista_total = arbitriosProvider.totalLimpieza;
    final List<dynamic> datos = predioProvider.datos;

    final String global = arbitriosProvider.arbitriosGlobalLimpieza;
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 65,
        elevation: 10,
        backgroundColor: InterfaceColor.colorg,
        leading: IconButton(
          iconSize: 40,
                ...
                slivers: [
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                        childCount: datos.length, (context, index) {
                      return Container(
                        child: Container(
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      ...
                      (context, index) {
                        ...
                        String cantidad =
                            lista_deudas_por_anios[index]['cantidad'];
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () async {
                              ...
                              final deudasProvider =
                                  Provider.of<ArbitriosProvider>(context,
                                      listen: false);
